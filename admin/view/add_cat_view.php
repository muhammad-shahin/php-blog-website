...
if (isset($_POST['add_cat'])) {
 $addCatMsg = $objBlogSiteAdmin->add_cat($_POST);
}
?>
...
<head>
 ...
 <title>Add Category - PHP Blog Website</title>
</head>

<body>
 <div class="w-full space-y-6 p-10">
  <h1 class="text-4xl">Add New Category</h1>
  <form action="" method="POST" class="space-y-6">
   ...
   <p class="font-medium text-green-500"><?php if (isset($addCatMsg)) {
                                          echo $addCatMsg;
                                         } ?></p>
   <div class="flex flex-col max-w-lg">
